<h2>UPDATE TOUR</h2>
<h3><a href="index.php?action=list_tour">Danh sách tour</a></h3>
<form action="index.php?action=update_tour&id=<?= isset($infor_tour['id']) ? $infor_tour['id'] : ""?>" method="post" enctype="multipart/form-data">
    <div class="">
    ...
    <div>description:
        <input type="text" name="description" value="<?= isset($infor_tour['description']) ? $infor_tour['description'] : "" ?>">
    </div>
    <div>number_date:
        <input type="number" name="number_date" value="<?= isset($infor_tour['number_date']) ? $infor_tour['number_date'] : "" ?>">
